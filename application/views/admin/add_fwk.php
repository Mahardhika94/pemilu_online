        ...
        <div class="row">
		 <div class="col-md-3"></div>
          <div class="col-md-6">
            <div class="card">
              <div class="card-body">
			  <h3 class="text-center">Masukkan Foto Wakil Ketua</div>
			  <form action="<?php echo site_url('Up_admin/up_fwk'); ?>" method="post" enctype="multipart/form-data">
				  ...
				  <div class="input-group col-xs-5">
					...
					pattern=".{0}|.{8}" required title="Panjang minimal 8 karakter" name="nimwk" value="<?php echo $nimwk; ?>" readonly>
					<input type="text" name="nimk" value="<?php echo $nimk; ?>" hidden>
                  </div>
				  </div>
				  ...
				  <div class="form-group">
        <label>Unggah Foto <small>Ukuran gambar kurang dari 250 Kb dan >= 200 X 200 pixel</small></label>
        <div class="input-group">
