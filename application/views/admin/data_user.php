    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-edit fa-lg"></i> Data User</h1>
            <p></p>
          </div>
          <div>
            <ul class="breadcrumb">
			   ...
			   <table class="table table-hover table-bordered" id="sampleTable">
				  ...
				  <?php foreach($data as $row){ ?>
                    <tr>
                      ...
                      <td class="text-center"><a class="btn btn-danger" href="<?php echo site_url('Admin/del_user/'. $row->id_user .'' );?>"><span class="fa fa-remove"></span> Hapus</a>
					  </td>
                    </tr>
