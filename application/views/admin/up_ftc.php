...
#img-upload{
  ...
  <body class="sidebar-mini fixed">
    ...
    <div class="wrapper">
      <!-- Navbar-->
      <header class="main-header hidden-print"><a class="logo" href="#">A<div class="enjoy-css">Admin CPanel</div></a>
      ...
      <div class="content-wrapper">
        ...
        <div class="row">
		 <div class="col-md-3"></div>
          <div class="col-md-6">
			...
			<?php if($kon == 1){ ?>
              <div class="card-body">
			  <h3 class="text-center">Perbarui Foto Ketua</div>
			  <form action="<?php echo site_url('Up_admin/up_imk/'. $id_calon .'/'.$foto); ?>" method="post" enctype="multipart/form-data">
		<div class="row">
		<div class="col-md-4"></div>
		<div class="col-md-4"><img class="img img circle" src="<?php echo base_url(); ?>asset/img/calon/ketua/<?php echo $foto; ?>" width="120" height="120"></img></div>
		<div class="col-md-4"></div>
		</div>
		...
		<button type="submit" class="btn btn-info">Perbarui</button>
				...
				<div class="card-body">
			  <h3 class="text-center">Perbarui Foto Wakil Ketua</div>
			  <form action="<?php echo site_url('Up_admin/up_imwk/'. $id_calon .'/'.$foto); ?>" method="post" enctype="multipart/form-data">
		<div class="row">
		<div class="col-md-4"></div>
		<div class="col-md-4"><img class="img img circle" src="<?php echo base_url(); ?>asset/img/calon/wakil/<?php echo $foto; ?>" width="120" height="120"></img></div>
		<div class="col-md-4"></div>
		</div>
		<div class="form-group">
				  <div class="input-group">
