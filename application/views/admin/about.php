    ...
    <div class="wrapper">
       ...
       <aside class="main-sidebar hidden-print">
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="<?php echo site_url('Admin/about'); ?>"><i class="fa fa-clone"></i><span> Tentang</span></a>
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-clone fa-lg"></i> About</h1>
            <p></p>
          </div>
          <div>
            <ul class="breadcrumb">
		...
		<div class="col-md-2"></div>
          <div class="col-md-8">
            <div class="card ">
			  ...
			  <form action="<?php echo site_url('Up_admin/up_about/'. $id_about); ?>" method="post">
			  <div class="form-group">
			  <div class="input-group col-xs-12">
			  <label class="label-control">About/Tentang</label>
			  <textarea  class="form-control " name="about" ><?php echo $ket; ?></textarea>
			  </div>
			  </div>
			  
			  <button type="submit" class="btn btn-primary"><span class="fa fa-check"></span> Save About</button>
