    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-edit fa-lg"></i> Tamabah User</h1>
            <p></p>
          </div>
          <div>
            <ul class="breadcrumb">
        ...
        <div class="row">
		  ...
		  <div class="col-md-3"></div>
             <div class="col-md-6">
            <div class="card">
			<h4			  class="text-center">Tambah User</h4><p>
              <div class="card-body">
			  <form action="<?php echo site_url('Ins_data/add_user'); ?>" method="post">
				
                
				  <div class="form-group">
				<div class="input-group col-xs-10">
				 <label class="control-label">Usename</label>
				  <input class="form-control " type="tex" placeholder="Username" name="username" >
				  </div>
				  </div>
                ...
                <a href="<?php echo site_url('Admin/data_user'); ?>" class="btn btn-info"><span class="fa fa-eye"></span> Lihat User</a>
