        ...
        <section class="sidebar">
          <div class="user-panel">
            ...
            <div class="pull-left info">
              ...
              <p class="designation">Admitrator</p>
            </div>
          </div>
          <!-- Sidebar Menu-->
      ...
      <div class="content-wrapper">
		...
		<div class="col-md-12">
            <div class="card">
             <div class="row">
          <div class="col-md-12">
            <h1 class="text-center">Pilih Statistik</h1>
          </div>
        </div>
        <div class="row">
          <div class="col-md-offset-3 col-md-6">
            <form role="form" action="<?php echo site_url('Admin/statistik'); ?>" method="post">
             ...
             <ul class="event-list">
					<li>
						<time datetime="2014-07-20">
							<span class="day"><?php echo $row->nourut; ?></span>
						
						</time>
					
						<div class="info">
							<h2 class="title"><?php echo $row->lembaga; ?></h2>
							<p class="desc">Ketua : <?php echo $row->nama_ketua; ?></p>
							<p class="desc">Wakil : <?php echo $row->nama_wakil; ?></p>
							<p class="desc">Suara : <?php echo $row->jumlah; ?></p>
						</div>
