    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="page-title">
          <div>
            <h1><i class="fa fa-edit fa-lg"></i> Data Calon</h1>
            <p></p>
          </div>
          <div>
            <ul class="breadcrumb">
			   ...
			   <table class="table table-hover table-bordered" id="sampleTable">
				  ...
				  <?php  foreach($data as $row){ ?>
                    <tr>
                      ...
                      <td class="text-center"><a class="btn btn-danger" href="<?php echo site_url('Admin/del_calon/'. $row->id_calon );?>"><span class="fa fa-remove"></span> Hapus</a>
					  <a class="btn btn-info" href="<?php echo site_url('Admin/det_calon/'. $row->id_calon );?>"><span class="fa fa-edit"></span> Perbarui</a>
					  </td>
                    </tr>
                   <?php } ?>
