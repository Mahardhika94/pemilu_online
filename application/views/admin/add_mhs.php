    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
		 ...
		 <div class="col-md-3"></div>
          <div class="col-md-6">
            <div class="card center">
			  ...
			  <form action="<?php echo site_url('Ins_data/add_mhs'); ?>" method="post" role="form">
				...
				<div class="input-group col-xs-8">
				 <label class="control-label">Nama</label>
				  <input class="form-control " type="tex" placeholder="nama" name="nama" required >
				  </div>
				  </div>
				...
				<div class="input-group col-xs-6">
				 <label class="control-label">Tanggal Lahir</label>
				  <input class="form-control " type="tex" placeholder="Tanggal Lahir" id="demoDate"  name="tgl" required>
				  </div>
				  </div>
        ...
        <option>FISE</option>
				  ...
				  <select class="form-control" type="text" placeholder="Prodi" name="prodi" id="prodi" required >
				  </select>
				  </div>
				  </div>
				  ...
				  <label class="control-label ">Tahun Masuk</label>
				   <input type="text" class="form-control" placeholder="Tahun Masuk" name="thm" id="demoDate2" required>
				  </div>
