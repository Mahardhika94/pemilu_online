...
.enjoy-css {
  ...
  text-overflow: ellipsis;
	...
	<!---start-wrap---->
		...
		<div class="skills">
				   			 <center><h3 text="cc">Statistik Pemilu Organisasi Mahasiswa UNRIYO</h3></center>
								
		                <ul>
							  <li>
							 
							  <a class="btn btn-warning btn-block"   href="<?php echo site_url('User/sel_stat/bem Universitas'); ?>"  ><span class="fa fa-check"></span> Statistik Bem Universitas</a> 
							  </li>
		                        <li>
								<a class="btn btn-warning btn-block" href="<?php echo site_url('User/sel_stat/Dpm'); ?>" ><span class="fa fa-check"></span> Statistik DPM Universitas</a> 	
								</li>  
								<li>
								<a class="btn btn-warning btn-block" href="<?php echo site_url('User/sel_stat/'. $bemf); ?>" ><span class="fa fa-check"></span> Statistik <?php echo $bemf; ?></a> 	
								</li> 
								<li>
								<a class="btn btn-warning btn-block" href="<?php echo site_url('User/sel_stat/'. $hima); ?>" ><span class="fa fa-check"></span> Statistik <?php echo $hima; ?></a> 	
								</li> 
								<li>
