...
.enjoy-css {
  ...
  text-overflow: ellipsis;
	...
	<body>
		...
		<div class="sign-in">
						 	    <div class="sign_in">
						          <center> <div class="enjoy-css"><h3>Login Mahasiswa</h3></div> </center>
							    <form action="<?php echo site_url('Login/login_user'); ?>" method="post">
							    	<span>
							 	    <i class="user"> </i><input  type="text" value="Username" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Nim';}" name="nim">
							 	    </span>
							 	    <span>
									
							 	     <i class="lock"> </i>
							 	     <input  type="password" value="**********" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '**********';}" name="pass">
							 	    </span>
		...
		<div data-role="dialog" id="dialog6" class="padding20" data-close-button="true" data-type="success">
           <center> <h1>Info</h1></center>
            <p>
               Sebelum melakukan  pemilihan, Mahasiswa harus Login Terelebih dahulu (untuk login awal gunakan nim sebagai username dan password anda.. 
            </p>
