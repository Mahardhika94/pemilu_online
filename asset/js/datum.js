...
document.getElementById('prodi').innerHTML ="<option>Pilih Prodi</option><option>Fisioterapi</option><option>Keperawatan</option><option>NERS</option><option>KEBIDANAN D-III</option><option>Ilmu Gizi</option><option>Kesehatan Masyarakat</option><option>Bidan Pendidik</option>";
}else if(fak =='FISE'){
